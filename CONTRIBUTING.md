# Contributing to `coolms/core-module`
...
`coolms/core-module` is a **platform package** -- it builds on `coolms/core` and only
...
`coolms/core-module 2.0.0` does not assert that this package broke something; it
